...
namespace Sudoku
{
    class SudokuSolver
    {
        ...
        private bool[] GetPossibleDigits(int row, int col)
        {
            ...
            // Search in square
            int topLeftRow = row - row % 3; // biggest integer that is lower than i and is divisible by 3
            int topLeftCol = col - col % 3; // biggest integer that is lower than col and is divisible by 3
        ...
        private void SolveWithRecursion(int row, int col, int empty)
        {
            ...
            bool[] possibleDigits = GetPossibleDigits(row, col); // candidates for the current cell
